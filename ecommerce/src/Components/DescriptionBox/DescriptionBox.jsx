  ...
  return (
    <div className='descriptionbox'>
        ...
        <div className="desriptionbox-description">
            ...
            The main difference between e-commerce and physical commerce, however, is that e-commerce transactions occur entirely over the internet rather than at a brick-and-mortar location.
            </p>
        </div>
    </div>
  )
